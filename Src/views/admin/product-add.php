...
if(isset($_POST["submit"])) {
    ...
    $isInsert = $CMSNT->insert("products", ["stt" => !empty($_POST["stt"]) ? check_string($_POST["stt"]) : 0, "code" => !empty($_POST["code"]) ? check_string($_POST["code"]) : uniqid(), "user_id" => $getUser["id"], "name" => !empty($_POST["name"]) ? check_string($_POST["name"]) : NULL, "slug" => !empty($_POST["slug"]) ? check_string($_POST["slug"]) : NULL, "images" => trim($images), "short_desc" => !empty($_POST["short_desc"]) ? check_string($_POST["short_desc"]) : NULL, "description" => !empty($_POST["description"]) ? base64_encode($_POST["description"]) : NULL, "flag" => !empty($_POST["flag"]) ? check_string($_POST["flag"]) : NULL, "note" => !empty($_POST["note"]) ? base64_encode($_POST["note"]) : NULL, "text_txt" => !empty($_POST["text_txt"]) ? check_string($_POST["text_txt"]) : NULL, "price" => !empty($_POST["price"]) ? check_string($_POST["price"]) : 0, "min" => !empty($_POST["min"]) ? check_string($_POST["min"]) : 1, "max" => !empty($_POST["max"]) ? check_string($_POST["max"]) : 1000000, "cost" => !empty($_POST["cost"]) ? check_string($_POST["cost"]) : 0, "discount" => !empty($_POST["discount"]) ? check_string($_POST["discount"]) : 0, "check_live" => !empty($_POST["check_live"]) ? check_string($_POST["check_live"]) : "None", "category_id" => check_string($_POST["category_id"]), "status" => check_string($_POST["status"]), "order_by" => !empty($_POST["order_by"]) ? check_string($_POST["order_by"]) : 1, "allow_api" => !empty($_POST["allow_api"]) ? check_string($_POST["allow_api"]) : 0, "sold" => !empty($_POST["sold"]) ? check_string($_POST["sold"]) : 0, "create_gettime" => gettime(), "update_gettime" => gettime()]);
    if($isInsert) {
