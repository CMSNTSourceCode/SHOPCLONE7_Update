...
if(isset($_POST["SaveSettings"])) {
    ...
    echo $CMSNT->site("crypto_type_api") == "fpayment.co" ? "selected" : "";
    echo "                                                value=\"fpayment.co\">FPAYMENT.CO | TRC20\n                                            </option>\n                                            <option\n                                                ";
    echo $CMSNT->site("crypto_type_api") == "fpayment.net" ? "selected" : "";
    echo "                                                value=\"fpayment.net\">FPAYMENT.NET | TRC20, BEP20, POLYGON, SOLANA\n                                            </option>\n                                        </select>\n                                    </div>\n                                </div>\n\n                                <div id=\"fpaymentCoFields\" class=\"crypto-fields\">\n                                    <div class=\"row mb-4\">\n                                        <label class=\"col-sm-4 col-form-label\" for=\"example-hf-email\">Address</label>\n                                        <div class=\"col-sm-8\">\n                                            <input type=\"text\" class=\"form-control\"\n                                                value=\"";
    ...
    echo $CMSNT->site("crypto_merchant_id");
