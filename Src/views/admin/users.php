...
echo __("WARNING");
echo "\",\n        message: \"";
echo __("Hệ thống sẽ đăng xuất tất cả thành viên, bao gồm Admin, có chắc chắn muốn tiếp tục không?");
echo "\",\n        confirmText: \"";
echo __("Agree");
echo "\",\n        cancelText: \"";
echo __("Close");
...
echo __("WARNING");
echo "\",\n        message: \"";
echo __("Hệ thống sẽ thay đổi API KEY cho tất cả thành viên, bao gồm Admin, có chắc chắn muốn tiếp tục không?");
echo "\",\n        confirmText: \"";
echo __("Agree");
echo "\",\n        cancelText: \"";
echo __("Close");
