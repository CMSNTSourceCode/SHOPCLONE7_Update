...
if(isset($_POST["SaveSettings"])) {
    ...
    echo "\"\n                                                name=\"limit_block_ip_admin_access\">\n                                        </div>\n                                    </div>\n                                    <div class=\"row mb-4\">\n                                        <label class=\"col-sm-5 col-form-label\">Chỉ được đăng nhập Admin Panel đồng thời 1 địa chỉ IP</label>\n                                        <div class=\"col-sm-7\">\n                                            <select class=\"form-control\" name=\"status_only_ip_login_admin\" required>\n                                                <option value=\"0\" ";
    echo $CMSNT->site("status_only_ip_login_admin") == 0 ? "selected" : "";
    echo ">OFF</option>\n                                                <option value=\"1\" ";
    echo $CMSNT->site("status_only_ip_login_admin") == 1 ? "selected" : "";
    echo ">ON</option>\n                                            </select>\n                                        </div>\n                                    </div>\n                                    <div class=\"row mb-4\">\n                                        <label class=\"col-sm-5 col-form-label\">Chỉ được đăng nhập Admin Panel đồng thời 1 thiết bị</label>\n                                        <div class=\"col-sm-7\">\n                                            <select class=\"form-control\" name=\"status_only_device_admin\" required>\n                                                <option value=\"0\" ";
    echo $CMSNT->site("status_only_device_admin") == 0 ? "selected" : "";
    echo ">OFF</option>\n                                                <option value=\"1\" ";
    echo $CMSNT->site("status_only_device_admin") == 1 ? "selected" : "";
    echo ">ON</option>\n                                            </select>\n                                        </div>\n                                    </div>\n                                    <div class=\"row mb-4\">\n                                        <label class=\"col-sm-5 col-form-label\">Chỉ được đăng nhập Trang khách đồng thời 1 thiết bị</label>\n                                        <div class=\"col-sm-7\">\n                                            <select class=\"form-control\" name=\"status_only_device_client\" required>\n                                                <option value=\"0\" ";
    echo $CMSNT->site("status_only_device_client") == 0 ? "selected" : "";
    echo ">OFF</option>\n                                                <option value=\"1\" ";
    echo $CMSNT->site("status_only_device_client") == 1 ? "selected" : "";
