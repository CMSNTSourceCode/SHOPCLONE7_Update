...
if(isset($_GET["user_id"]) && $_GET["user_id"] !== "") {
    $user_id = check_string((int) $_GET["user_id"]);
    if($user_id == 0) {
        $where .= " AND `user_id` = 0 ";
    } else {
...
foreach ($listDatatable as $row) {
    ...
    echo "</td>\n                                        <td>\n                                            ";
    if($row["user_id"] == 0) {
        echo "                                                <span class=\"badge bg-info text-white\"><i class=\"fas fa-server me-1\"></i> Hệ thống</span>\n                                            ";
    } else {
        echo "                                                <a class=\"text-primary\" href=\"";
