...
$body = ["title" => __("Recharge THESIEURE"), "desc" => "CMSNT Panel", "keyword" => "cmsnt, CMSNT, cmsnt.co,"];
$body["header"] = "\n \n\n";
$body["footer"] = "\n \n";
...
if(isset($_POST["SaveSettings"])) {
    ...
    $CMSNT->insert("logs", ["user_id" => $getUser["id"], "ip" => myip(), "device" => $Mobile_Detect->getUserAgent(), "createdate" => gettime(), "action" => __("Cấu hình nạp THESIEURE")]);
    ...
    $currentYear = date("Y");
    $currentDate = date("Y-m-d");
    $total_yesterday = (int) $CMSNT->get_row("SELECT SUM(amount) FROM payment_thesieure WHERE  `create_gettime` LIKE '%" . $yesterday . "%' ")["SUM(amount)"];
    ...
    if(120 <= time() - $CMSNT->site("check_time_cron_thesieure")) {
        ...
        echo "\"\n                target=\"_blank\">";
        echo base_url("cron/thesieure.php");
    ...
    echo $CMSNT->site("thesieure_status") == 1 ? "selected" : "";
    echo "                                                    value=\"1\">ON\n                                                </option>\n                                                <option ";
    echo $CMSNT->site("thesieure_status") == 0 ? "selected" : "";
    echo "                                                    value=\"0\">OFF\n                                                </option>\n                                            </select>\n                                        </div>\n                                    </div>\n                                    <div class=\"row mb-4\">\n                                        <label class=\"col-sm-4 col-form-label\" for=\"example-hf-email\">Số điện thoại\n                                            THESIEURE</label>\n                                        <div class=\"col-sm-8\">\n                                            <input type=\"text\" class=\"form-control\"\n                                                value=\"";
    echo $CMSNT->site("thesieure_number");
    echo "\" name=\"thesieure_number\">\n                                        </div>\n                                    </div>\n                                    <div class=\"row mb-4\">\n                                        <label class=\"col-sm-4 col-form-label\" for=\"example-hf-email\">Địa chỉ Email\n                                            THESIEURE</label>\n                                        <div class=\"col-sm-8\">\n                                            <input type=\"text\" class=\"form-control\"\n                                                value=\"";
    echo $CMSNT->site("thesieure_email");
    echo "\" name=\"thesieure_email\">\n                                        </div>\n                                    </div>\n                                    <div class=\"row mb-4\">\n                                        <label class=\"col-sm-4 col-form-label\" for=\"example-hf-email\">Chủ tài khoản\n                                            THESIEURE</label>\n                                        <div class=\"col-sm-8\">\n                                            <input type=\"text\" class=\"form-control\"\n                                                value=\"";
    echo $CMSNT->site("thesieure_name");
    echo "\" name=\"thesieure_name\">\n                                        </div>\n                                    </div>\n                                </div>\n                                <div class=\"col-lg-12 col-xl-6\">\n                                    <div class=\"row mb-4\">\n                                        <label class=\"col-sm-6 col-form-label\" for=\"example-hf-email\">Token API\n                                            Auto</label>\n                                        <div class=\"col-sm-6\">\n                                            <input type=\"text\" class=\"form-control\"\n                                                value=\"";
    echo $CMSNT->site("thesieure_token");
    echo "\" name=\"thesieure_token\">\n                                        </div>\n                                    </div>\n                                    <div class=\"row mb-4\">\n                                        <label class=\"col-sm-6 col-form-label\"\n                                            for=\"example-hf-email\">";
    echo __("Prefix");
    ...
    echo __("Note");
    echo "</label>\n                                        <div class=\"col-sm-12\">\n                                            <textarea id=\"thesieure_notice\"\n                                                name=\"thesieure_notice\">";
    echo $CMSNT->site("thesieure_notice");
    ...
    echo format_currency($CMSNT->get_row("SELECT SUM(amount) FROM payment_thesieure WHERE  MONTH(create_gettime) = '" . $currentMonth . "' AND YEAR(create_gettime) = '" . $currentYear . "' ")["SUM(amount)"]);
    echo "                                        </p>\n                                        <p class=\"mb-0 text-muted\">Tháng ";
    echo date("m");
    echo "</p>\n                                    </div>\n                                    <div class=\"ms-2\">\n                                        <span class=\"avatar text-bg-info rounded-circle fs-20\"><i\n                                                class='bx bxs-wallet-alt'></i></span>\n                                    </div>\n                                </div>\n                            </div>\n                        </div>\n                    </div>\n                    <div class=\"col-xl-6\">\n                        <div class=\"card custom-card\">\n                            <div class=\"card-body\">\n                                <div class=\"d-flex align-items-center\">\n                                    <div class=\"flex-fill\">\n                                        <p class=\"mb-1 fs-5 fw-semibold text-default\">\n                                            ";
    echo format_currency($CMSNT->get_row("SELECT SUM(amount) FROM payment_thesieure WHERE  YEAR(create_gettime) = " . $currentYear . " AND WEEK(create_gettime, 1) = " . $currentWeek . " ")["SUM(amount)"]);
    ...
    echo "                                                <strong\n                                                    style=\"color:red;\">";
    echo format_currency($CMSNT->get_row(" SELECT SUM(`amount`) FROM `payment_thesieure` WHERE " . $where . " ")["SUM(`amount`)"]);
    echo "</strong>\n                                                |\n\n                                                ";
    echo __("Thực nhận:");
    echo "                                                <strong\n                                                    style=\"color:blue;\">";
    echo format_currency($CMSNT->get_row(" SELECT SUM(`received`) FROM `payment_thesieure` WHERE " . $where . " ")["SUM(`received`)"]);
