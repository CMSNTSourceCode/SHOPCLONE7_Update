...
echo date("Y");
echo "</option>\n                            </select>\n                        </div>\n                    </div>\n                    <div class=\"card-body\">\n                        <canvas id=\"chartjs-line\" class=\"chartjs-chart\" style=\"height: 300px;\"></canvas>\n                        <script>\n                        (function() {\n                            document.addEventListener('DOMContentLoaded', function() {\n                                let myChart;\n                                \n                                function loadChartData(timeRange) {\n                                    // Cập nhật tiêu đề\n                                    let titleText;\n                                    switch(timeRange) {\n                                        case 'week':\n                                            titleText = 'THỐNG KÊ ĐƠN HÀNG API 7 NGÀY GẦN ĐÂY';\n                                            break;\n                                        case 'month':\n                                            titleText = 'THỐNG KÊ ĐƠN HÀNG API THÁNG ";
echo date("m");
echo "';\n                                            break;\n                                        case 'year':\n                                            titleText = 'THỐNG KÊ ĐƠN HÀNG API NĂM ";
echo date("Y");
...
echo "',\n                                        method: 'POST',\n                                        dataType: 'json',\n                                        data: {\n                                            action: 'view_chart_thong_ke_don_hang_api',\n                                            token: '";
echo $getUser["token"];
...
foreach ($listDatatable as $supplier) {
    ...
    echo $supplier["id"];
    echo "`)\">\n                                        <td>\n                                            ";
    if(!empty($supplier["domain"])) {
        echo "                                                <i class=\"fa-solid fa-link\"></i> Domain: <a class=\"text-primary\"\n                                                    href=\"";
    ...
    echo "                                            \n                                            ";
    if(!empty($supplier["username"])) {
        echo "                                                <i class=\"fa-solid fa-user\"></i> Username:\n                                                <strong>";
        echo substr($supplier["username"], 0, 4);
        echo "...</strong><br>\n                                            ";
    }
    echo "                                            \n                                            ";
    if(!empty($supplier["password"])) {
        echo "                                                <i class=\"fa-solid fa-lock\"></i> Password:\n                                                <strong>";
        echo substr($supplier["password"], 0, 4);
        echo "...</strong><br>\n                                            ";
    }
    echo "                                            \n                                            ";
    if(!empty($supplier["api_key"])) {
        echo "                                                <i class=\"fa-solid fa-key\"></i> API Key:\n                                                <strong>";
        echo substr($supplier["api_key"], 0, 12);
        echo "...</strong><br>\n                                            ";
    }
    echo "                                            \n                                            ";
    if(!empty($supplier["token"])) {
        echo "                                                <i class=\"fa-solid fa-key\"></i> Token:\n                                                <strong>";
    ...
    echo "                                            <span class=\"badge bg-outline-warning\">Chuyên mục: ";
    echo $categoryCount;
    ...
    echo "                                            Tăng giá: <span class=\"badge bg-outline-primary\">";
    echo $supplier["discount"];
    echo "%</span><br>\n                                            Cập nhật tên sản phẩm: <span class=\"badge bg-";
    echo $updateNameBadge;
    echo "\">";
    echo $supplier["update_name"];
    echo "</span><br>\n                                            Cập nhật giá bán: <span class=\"badge bg-";
    echo $updatePriceBadge;
    echo "\">";
    echo $supplier["update_price"];
    echo "</span><br>\n                                            Làm tròn giá bán: <span class=\"badge bg-";
    echo $roundMoneyBadge;
    echo "\">";
    echo $supplier["roundMoney"];
    echo "</span><br>\n                                            Đồng bộ chuyên mục API: <span class=\"badge bg-";
    echo $syncCategoryBadge;
    echo "\">";
    echo $supplier["sync_category"];
