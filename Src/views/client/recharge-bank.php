...
foreach ($CMSNT->get_list("SELECT * FROM `banks` WHERE `status` = 1 ") as $bank) {
    ...
    if($bank["short_name"] == "MOMO") {
        echo "                            <img src=\"https://api.web2m.com/api/qrmomo.php?amount=0&phone=";
        echo $bank["accountNumber"];
        echo "&noidung=";
        echo urlencode($CMSNT->site("prefix_autobank")) . $getUser["id"];
        echo "&size=300\" width=\"300px\" style=\"display:block;\" onerror=\"this.style.display='none'; document.getElementById('default-";
        echo $bank["id"];
        ...
        echo "                            <img src=\"";
        echo $img;
        echo "\" width=\"300px\" style=\"display:block;\" id=\"vietqr-";
        echo $bank["id"];
        echo "\" onerror=\"this.style.display='none'; document.getElementById('default-";
        echo $bank["id"];
        echo "').style.display='block';\"/>\n                            <img class=\"mb-3\" src=\"";
        echo base_url($bank["image"]);
        echo "\" width=\"300px\" style=\"display:none;\" id=\"default-";
        echo $bank["id"];
        echo "\">\n                            ";
    }
