...
if($CMSNT->site("thesieure_status") == 1) {
    ...
    echo "\"><img width=\"20px\"\n                                                src=\"";
    echo base_url("mod/img/icon-thesieure.webp");
    echo "\">\n                                            ";
    echo __("Ví THESIEURE");
    echo "</a>\n                                    </li>\n                                    ";
}
echo "                                    ";
...
if($CMSNT->site("gateway_xipay_status") == 1) {
    ...
    echo "\"><img width=\"20px\"\n                                                src=\"";
    echo base_url("mod/img/logo-xipay.webp");
    echo "\">\n                                            ";
    echo __("AliPay & WeChat Pay");
    echo "</a></li>\n                                    ";
}
echo "                                    ";
if($CMSNT->site("korapay_status") == 1) {
    ...
    echo "\"><img width=\"20px\"\n                                                src=\"";
    echo base_url("mod/img/logo-korapay.webp");
    echo "\">\n                                            ";
    echo __("Korapay Africa");
    echo "</a></li>\n                                    ";
}
echo "                                    ";
if($CMSNT->site("tmweasyapi_status") == 1) {
    ...
    echo "\"><img width=\"20px\"\n                                                src=\"";
    echo base_url("mod/img/icon-tmweasyapi.webp");
    echo "\">\n                                            ";
...
if($CMSNT->site("openpix_status") == 1) {
    ...
    echo "\"><img width=\"20px\"\n                                                src=\"";
    echo base_url("mod/img/icon-openpix.webp");
    echo "\">\n                                            ";
    echo __("OpenPix");
    echo "</a></li>\n                                    ";
}
...
if($CMSNT->site("bakong_status") == 1) {
    echo " \n                                    <li><a href=\"";
    echo base_url("?action=recharge-bakong");
    echo "\"><img width=\"20px\"\n                                                src=\"";
    echo base_url("mod/img/icon-bakong.webp");
    echo "\">\n                                            ";
    echo __("Bakong Wallet Cambodia");
    echo "</a></li>\n                                    ";
}
echo "                                    ";
...
echo $CMSNT->site("icon_hotline");
echo "                                <p><small>";
echo __("Hotline");
echo "</small><span>";
echo $CMSNT->site("hotline");
echo "</span></p>\n                            </div>\n                            <div class=\"navbar-info\">";
echo $CMSNT->site("icon_email");
echo "                                <p><small>";
echo __("Email");
echo "</small><span>";
